...
export default function Projects() {
  return (
    <section id='projects' className='text-gray-400 bg-gray-50 body-font'>
          ...
          {projects.map((project) => (
            ...
            >
              <div className='flex relative'>
                ...
                <div className='px-2 py-10 relative z-10 w-full h-56 border-4 border-gray-800 bg-gray-900 opacity-0 hover:opacity-100'>
